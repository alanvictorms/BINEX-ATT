  ...
  return (
    ...
    >
      <img
        ...
        width={size}
        height={size}
        className="absolute left-0 top-0 rounded-full object-cover border-2 border-[#0E1620] z-10"
      ...
      <img
        ...
        width={size}
        height={size}
        className="absolute top-0 rounded-full object-cover border-2 border-[#0E1620] z-0"
