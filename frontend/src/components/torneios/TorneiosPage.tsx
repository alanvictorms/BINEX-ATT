...
function TorneioCard({ torneio }: { torneio: typeof TORNEIOS[0] }) {
  return (
    <div className="relative rounded-2xl overflow-hidden bg-[#1e2235] border border-[#16202D] flex flex-col">
      <CardPattern />
      ...
      <div className="relative px-6 pt-5 pb-4 flex-1">
        ...
        <div className="flex items-start justify-between gap-4 mb-6">
          ...
          <div className="text-right flex-shrink-0">
            <div className="text-[10px] font-semibold text-[#7E8DA2] tracking-widest mb-1">RESERVA DE PRÊMIOS</div>
        ...
        <div className="flex items-center gap-10">
          <div>
            ...
            <div className="text-xs text-[#7E8DA2] mt-0.5">Taxa de entrada</div>
          </div>
          <div>
            <div className="text-lg font-bold text-white">{torneio.duracao}</div>
            <div className="text-xs text-[#7E8DA2] mt-0.5">Duração</div>
          </div>
        </div>
      </div>

      {/* Details button */}
      <button className="relative w-full flex items-center justify-center gap-2 py-3.5 bg-[#101825] hover:bg-[#2e3448] transition-colors border-t border-[#16202D]">
        <span className="text-sm font-semibold text-white">Detalhes</span>
        <div className="w-5 h-5 rounded-full border border-[#7E8DA2] flex items-center justify-center">
          <Info size={11} className="text-[#7E8DA2]" />
        </div>
      </button>
    </div>
  )
...
function TorneioCardConcluido({ torneio }: { torneio: typeof TORNEIOS_CONCLUIDOS[0] }) {
  return (
    <div className="relative rounded-2xl overflow-hidden bg-[#0E1620] border border-[#16202D] opacity-70 flex flex-col">
      <CardPattern />
      <div className="relative px-6 pt-5 pb-4 flex-1">
        <div className="mb-4">
          <span className="inline-flex items-center px-2.5 py-1 rounded-md bg-[#1B2735] text-[10px] font-bold text-[#7E8DA2] tracking-wide">
            CONCLUÍDO
          </span>
        </div>
        <div className="flex items-start justify-between gap-4 mb-6">
          ...
          <div className="text-right flex-shrink-0">
            <div className="text-[10px] font-semibold text-[#7E8DA2] tracking-widest mb-1">RESERVA DE PRÊMIOS</div>
            <div className="text-2xl font-bold text-[#7E8DA2]">{torneio.premio}</div>
          </div>
        </div>
        <div className="flex items-center gap-10">
          <div>
      ...
      <button className="relative w-full flex items-center justify-center gap-2 py-3.5 bg-[#1e2235] hover:bg-[#101825] transition-colors border-t border-[#16202D]">
        <span className="text-sm font-semibold text-[#7E8DA2]">Detalhes</span>
        <div className="w-5 h-5 rounded-full border border-[#1B2735] flex items-center justify-center">
          <Info size={11} className="text-[#1B2735]" />
        </div>
      </button>
    </div>
  )
  ...
  return (
    <div className="flex-1 flex flex-col bg-[#0A101A] min-h-0 overflow-hidden">
      ...
      <div className="px-8 pt-6 pb-0 flex-shrink-0">
        ...
        {/* Tabs */}
        <div className="flex items-center gap-8 border-b border-[#16202D]">
          <button
            onClick={() => setTab('ativo')}
            className={cn(
              'flex items-center gap-2 pb-3 text-sm font-bold tracking-wide border-b-2 -mb-px transition-colors',
              tab === 'ativo' ? 'text-blue-400 border-blue-400' : 'text-[#7E8DA2] border-transparent hover:text-white'
            )}
          >
            ATIVO
          ...
          <button
            ...
            className={cn(
              ...
              tab === 'concluido' ? 'text-blue-400 border-blue-400' : 'text-[#7E8DA2] border-transparent hover:text-white'
            )}
          >
            CONCLUÍDO
          </button>
        ...
        {tab === 'ativo' && (
          <>
            ...
            <div className="flex items-center gap-4 mb-6">
              <div className="flex-1 h-px bg-[#16202D]" />
