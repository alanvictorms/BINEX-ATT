...
export function SupportPanel({ onClose }: SupportPanelProps) {
  return (
    <div className="flex flex-col bg-[#0E1620] border-r border-[#16202D] flex-shrink-0"
      style={{ width: 240 }}
    >
      {/* Header */}
        ...
        {SUPPORT_ITEMS.map((item) => (
          ...
          >
            ...
            <div>
              ...
              <div className="text-xs text-[#7E8DA2] mt-0.5">{item.subtitle}</div>
            </div>
          </button>
        ))}
      </div>
      ...
      {/* Footer */}
      <div className="px-5 py-5 border-t border-[#16202D] flex flex-col items-center gap-2 text-center">
